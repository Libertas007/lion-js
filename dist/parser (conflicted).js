...
class SchemaParser {
    ...
    parseType() {
        ...
        while (((_a = this.currentToken) === null || _a === void 0 ? void 0 : _a.type) !== lexer_1.TokenType.COMMA &&
            ...
            ((_c = this.currentToken) === null || _c === void 0 ? void 0 : _c.type) !== lexer_1.TokenType.RBRACE &&
            this.currentToken) {
            console.log(this.currentToken);
            if (((_d = this.currentToken) === null || _d === void 0 ? void 0 : _d.type) === lexer_1.TokenType.OF_TYPE_START ||
                ((_e = this.currentToken) === null || _e === void 0 ? void 0 : _e.type) === lexer_1.TokenType.OF_TYPE_END) {
